...
lay_Button = [
    ...
    [sg.Slider(range=(1,10),orientation="h",enable_events=True,pad=((5,0),(0,20)),size=(30,20),key="beside")]
...
layout = [[lay_mes],[sg.Column(lay_Button,vertical_alignment="c"),sg.Slider(range=(1,10),enable_events=True,pad=((0,20),(0,0)),size=(13,20),key="vertical"),sg.Column(lay_cap,vertical_alignment="c")]]
